  ...
  return (
    <div className="o_form_sheet shadow-lg mx-auto overflow-hidden p-0" style={{ maxWidth: '900px', borderRadius: '16px' }}>
      ...
      <div className="row g-0">
        ...
        {/* CỘT TRÁI: Branding - Đã sửa lỗi mất màu nền */}
        <div className="col-md-5 d-none d-md-flex flex-column align-items-center justify-content-center p-5 text-white" 
             style={{ 
                 backgroundColor: '#008784',  // Mã màu cứng (Teal)
                 background: 'linear-gradient(135deg, #008784 0%, #006e6b 100%)' // Gradient cứng
             }}>
          ...
          <p className="text-white-50 text-center small mb-4 px-3">
            Hệ thống quản lý yêu cầu và quy trình nội bộ tập trung.
          </p>
        ...
        <div className="col-md-7 bg-white p-5">
          <div className="d-flex align-items-center justify-content-between mb-4">
             <h4 className="fw-bold text-dark m-0">Đăng Nhập</h4>
             {/* Logo mobile - Giữ màu xanh */}
          ...
          <form onSubmit={onSubmit} className="d-flex flex-column gap-3">
            {/* Email */}
            <div>
              <label className="form-label fw-bold text-secondary small text-uppercase">Email công ty</label>
            ...
            <div>
              <div className="d-flex justify-content-between align-items-center mb-1">
                 <label className="form-label fw-bold text-secondary small text-uppercase mb-0">Mật khẩu</label>
              </div>
              <div className="input-group">
                <span className="input-group-text bg-light border-end-0 text-muted">
            ...
            <div className="d-flex justify-content-between align-items-center mt-2">
               <div className="form-check">
                  ...
                  <label className="form-check-label small text-muted" htmlFor="rememberMe">Ghi nhớ</label>
               </div>
               {/* Link màu xanh */}
          ...
          <div className="text-center mt-4 pt-3 border-top">
             <span className="text-muted small">Nhân viên mới? </span>
